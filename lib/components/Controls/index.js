...
var Controls = function Controls(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'button',
      { className: 'controls__button controls__button--zoom-in', onClick: zoomIn },
      'Zoom in'
    ),
    _react2.default.createElement(
      'button',
      { className: 'controls__button controls__button--zoom-out', disabled: scaleFactor <= 1, onClick: zoomOut },
      'Zoom out'
    )
  );
};
