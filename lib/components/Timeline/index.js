...
var _TodayMarker = require('./TodayMarker');

var _TodayMarker2 = _interopRequireDefault(_TodayMarker);

var _MouseMarker = require('./MouseMarker');

var _MouseMarker2 = _interopRequireDefault(_MouseMarker);

var _datePropType = require('../../utils/datePropType');

var _datePropType2 = _interopRequireDefault(_datePropType);

var _getRelativeMouseX = require('../../utils/getRelativeMouseX');
...
var Timeline = function (_Component) {
  ...
  (0, _createClass3.default)(Timeline, [{
    ...
    value: function handleMouseMove(e) {
      this.setState({
        mouseOffset: {
          x: (0, _getRelativeMouseX2.default)(e)
        }
      });
    }
  }, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            now && _react2.default.createElement(_TodayMarker2.default, { now: now, time: time }),
            _react2.default.createElement(_MouseMarker2.default, { mouseOffset: this.state.mouseOffset }),
