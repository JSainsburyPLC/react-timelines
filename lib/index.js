...
var getNumericPropertyValue = function getNumericPropertyValue(node, prop) {
  return parseInt(getComputedStyle(node, null).getPropertyValue(prop), 10);
};
...
var Container = function (_Component) {
  ...
  (0, _createClass3.default)(Container, [{
    ...
    value: function getSidebarWidth() {
      var layoutOffset = getNumericPropertyValue(this.layout, 'margin-left');
      var sidebarWidth = this.sidebar.offsetWidth + layoutOffset;
      this.setState({ sidebarWidth: sidebarWidth });
    }
  }, {
    key: 'getHeaderHeight',
    ...
    value: function getTimelineWidth(node) {
    ...
    value: function handleScroll() {
      ...
      requestAnimationFrame(function () {
        ...
        var _layoutMain$getBoundi = _this2.layoutMain.getBoundingClientRect(),
            top = _layoutMain$getBoundi.top,
            bottom = _layoutMain$getBoundi.bottom;
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          ...
          timelineVisualWidth = _state2.timelineVisualWidth;

      return _react2.default.createElement(
        'div',
        { className: 'react-timelines' },
        ...
        _react2.default.createElement(
          'div',
          { className: 'layout ' + (isOpen ? 'is-open' : ''), ref: function ref(layout) {
              _this4.layout = layout;
            } },
          _react2.default.createElement(
            'div',
            { className: 'layout__side', ref: function ref(sidebar) {
                _this4.sidebar = sidebar;
              } },
          ...
          _react2.default.createElement(
            'div',
            { className: 'layout__main', ref: function ref(layoutMain) {
                _this4.layoutMain = layoutMain;
              } },
